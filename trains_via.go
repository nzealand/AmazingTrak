...
// "VIA Rail Corridor" corridor (Quebec City-Windsor Corridor — the rest of
// VIA's network is trains_via_remote.go's 7 remote/long-distance corridors).
...
// (see trains_via_remote.go) — none of those remote services' numbers
// overlap this list, which is what lets via.go's loadVIADBTrains merge every
// VIA corridor into one flat number index.
